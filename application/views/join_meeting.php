...
<head>
  ...
  <meta name="author" content="localzet">
...
<body class="bg-gradient-primary" style="background-image: url(https://www.mixschool.ml/uploads/bglogin.jpg);">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <!-- <a href="<?php echo base_url(); ?>"> -->
                      <h1 class="h4 text-gray-900 mb-4"><?php echo get_app_config("app_name") ?></h1>
                    <!-- </a> -->
                  </div>
                  ...
                  <?php if (($check_availability_to_host_meeting && $check_availability_to_join_meeting) && $_GET['platform'] != 'mixschool') : ?>
                    <ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link link-right active" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="true">Создать</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link link-left" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="false">Присоединиться</a>
                      </li>
                    </ul>
                      ...
                      <div class="tab-pane fade" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <form class="user" action="<?php echo base_url('room/join'); ?>" method="post">
                          <div class="form-group">
                            <input type="text" name="meeting_code" class="form-control form-control-user" id="" aria-describedby="" placeholder="Введите ID конференции">
                          </div>
                          <button type="submit" class="btn btn-primary btn-user btn-block">Присоединиться</button>
                        </form>
                      </div>
                      <div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <form class="user" action="<?php echo base_url('room/create-and-join'); ?>" method="post">
                          <div class="form-group">
                          <label for="title_conf">Введите название</label>
                            <input type="text" name="meeting_title" value="" class="form-control form-control-user" id="title_conf" aria-describedby="" placeholder="Введите название конференции (необязательно)">
                          </div>
                          <div class="form-group">
                          <label for="id_conf">Скопируйте ID</label>
                            <input type="text" name="meeting_code1" value="<?php echo $meeting_code; ?>" disabled required class="form-control form-control-user" id="id_conf" aria-describedby="" placeholder="Введите ID конференции">
                          ...
                          <button type="submit" class="btn btn-primary btn-user btn-block">Создать</button>
                        </form>
                      </div>
                    </div>
                  <?php elseif (($check_availability_to_join_meeting) || $_GET['platform'] == 'mixschool') : ?>
                    <form class="user" action="<?php echo base_url('room/join'); ?>" method="post">
                      <div class="form-group">
                        <input type="text" name="meeting_code" class="form-control form-control-user" id="" aria-describedby="" placeholder="Введите ID конференции">
                      </div>
                  ...
                  <?php endif; ?>
                  <?php if ($this->session->userdata('login_status') != '1' && $_GET['platform'] != 'mixsh' && $_GET['platform'] != 'mixschool') : ?>
                    <hr>
                    <div class="text-center">
                      <a class="small" href="<?php echo base_url('login'); ?>">Login</a> |
                      <a class="small" href="<?php echo base_url('signup'); ?>">Signup</a>
